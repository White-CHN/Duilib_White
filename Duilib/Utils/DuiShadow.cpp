...
namespace DuiLib
{
    ...
    void CDuiShadow::Create(CDuiPaintManager* pPaintManager)
    {
        ...
        // Already initialized
        _ASSERT(CDuiPaintManager::GetInstance() != INVALID_HANDLE_VALUE);
        ...
        m_hWnd = CreateWindowEx(WS_EX_LAYERED | WS_EX_TRANSPARENT, strWndClassName, NULL,
                                ...
                                CW_USEDEFAULT, 0, 0, 0, hParentWnd, NULL, CDuiPaintManager::GetInstance(), NULL);
...
#pragma warning(default: 4311)
    ...
    {
        static std::map<HWND, CDuiShadow*> s_Shadowmap;
        return s_Shadowmap;
    }
...
#pragma warning(default: 4312)
    ...
    void CDuiShadow::Update(HWND hParent)
    {
    ...
    void CDuiShadow::MakeShadow(UINT32* pShadBits, HWND hParent, RECT* rcParent)
    {
